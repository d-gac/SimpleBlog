...
@section('dashboard')
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between">
            ...
            <div>
                <a class="btn btn-outline-success" style="padding: 0 20px;" href="{{route('post.create')}}">Dodaj <i class='fa fa-plus-square'></i></a>
            </div>
                ...
                @foreach($posts as $post)
                    <tr>
                        ...
                        <td class="d-flex flex-row bd-highlight">
                            <a class="btn btn-outline-success" href="{{route('post.show', $post->id)}}"><i class='fa fa-file-text'></i></a>
                            <a class="btn btn-outline-primary ms-1" href="{{route('post.edit', $post->id)}}"><i class='fa fa-edit'></i></a>
